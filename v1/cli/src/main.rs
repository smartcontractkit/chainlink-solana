...
pub struct Monitor {
    ...
    rpc: String, // supports using DNS for the RPC address, e.g. api.devnet.solana.com
    ...
    #[clap(long, about = "query interval", default_value = "1s")]
    query_interval: humantime::Duration,

    #[clap(long, about = "rdd polling interval", default_value = "1m")]
