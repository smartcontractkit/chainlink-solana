...
const ConfigSetAvroSchema = `
{
	...
	"fields": [
		...
		{"name": "contract_config", "fields": [
			{"name": "config_digest", "type": "bytes", "doc": "[32]byte"},
			{"name": "config_count", "type": "bytes", "doc": "uint64 big endian"},
			{"name": "signers", "type": "array", "items": "bytes"},
			{"name": "transmitters", "type": "array", "items": "bytes"},
			{"name": "f", "type": "long", "doc": "uint32"},
			...
			{"name": "offchain_config", "type": [
				{"name": "ocr2_offchain_config", "type": "record", "fields": [
					...
					{"name": "s", "type": "array", "items": "long", "doc": "[]uint32"},
					{"name": "offchain_public_keys", "type": "array", "items": "bytes"},
					{"name": "peer_ids", "type": "array", "items": "string"},
					{"name": "reporting_plugin_config", "type": [
						{"name": "ocr2_numerical_median_offchain_config", "type": "record", "fields": [
							...
							{"name": "alpha_accput_ppb", "type": "bytes", "doc": "uint64 big endian"},
					...
					{"name": "shared_secret_encryptions", "type": "record", "fields": [
						{"name": "diffie_hellman_point", "type": "bytes"},
						{"name": "shared_secret_hash", "type": "bytes"},
						{"name": "encryptions", "type": "array", "items": "bytes"}
					]}
				]}
			]}
		]},
		{"name": "state_account_contents", "type": "record", "fields": [
			{ "name": "account_discriminator", "type": "bytes", "doc": "[8]byte" },
			{ "name": "nonce", "type": "int" },
			{ "name": "config", "type": "record", "fields": [
			...
			{ "name": "leftover_payment", "type": "array", "items":
		...
		{"name": "solana_chain_config", "type": "record", "fields": [
			{"name": "network_name", "type": "string"},
			{"name": "network_id", "type": "string"},
			{"name": "chain_id", "type": "string"}
		]},
		{"name": "feed_config", "type": "record", "fields": [
...
const TransmissionAvroSchema = `
{
  ...
  "fields": [
		{"name": "block_number", "type": "bytes", "doc": "uint64 big endian"},
		{"name": "answer", "type": "record", "fields": [
			{"name": "value", "type": "bytes", "doc": "*big.Int"},
			{"name": "timestamp", "byte": "long", "doc": "uint32"}
		]},
		{"name": "solana_chain_config", "type": "record", "fields": [
			{"name": "network_name", "type": "string"},
			{"name": "network_id", "type": "string"},
...
func init() {
	...
	if err != nil {
		panic(fmt.Errorf("failed to parse Avro schema for the program config: %w", err))
	}
