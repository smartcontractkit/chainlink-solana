...
func (s *SolanaChainWriterService) handlePDALookup(ctx context.Context, decoded any, lookup PDALookup, derivedTableMap map[string][]*solana.AccountMeta, debugID string) ([]*solana.AccountMeta, error) {
...
func (s *SolanaChainWriterService) getSeedBytes(ctx context.Context, lookup PDALookup, decoded any, derivedTableMap map[string][]*solana.AccountMeta, debugID string) ([][]byte, error) {
	var seedBytes [][]byte
