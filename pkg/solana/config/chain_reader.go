...
type ReadDefinition struct {
	...
	PDAPrefix           string                      `json:"pdaPrefix,omitempty"` // Only used for PDA account reads
	Seeds				[]codec.SeedDefinition			`json:"seeds,omitempty"` // Only used for PDA account reads
}
