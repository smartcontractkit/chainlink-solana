...
// MaxRetention provides a mock function with no fields
func (_m *mockFilters) MaxRetention() time.Duration {
	ret := _m.Called()

	if len(ret) == 0 {
		panic("no return value specified for MaxRetention")
	}
...
// mockFilters_MaxRetention_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'MaxRetention'
type mockFilters_MaxRetention_Call struct {
	*mock.Call
}

// MaxRetention is a helper method to define mock.On call
func (_e *mockFilters_Expecter) MaxRetention() *mockFilters_MaxRetention_Call {
	return &mockFilters_MaxRetention_Call{Call: _e.mock.On("MaxRetention")}
}

func (_c *mockFilters_MaxRetention_Call) Run(run func()) *mockFilters_MaxRetention_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *mockFilters_MaxRetention_Call) Return(_a0 time.Duration) *mockFilters_MaxRetention_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *mockFilters_MaxRetention_Call) RunAndReturn(run func() time.Duration) *mockFilters_MaxRetention_Call {
	_c.Call.Return(run)
	return _c
}
