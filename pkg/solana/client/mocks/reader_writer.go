...
// GetAccountDataBorshInto provides a mock function with given fields: ctx, addr, accountType
func (_m *ReaderWriter) GetAccountDataBorshInto(ctx context.Context, addr solana.PublicKey, accountType interface{}) error {
	ret := _m.Called(ctx, addr, accountType)
...
// ReaderWriter_GetAccountDataBorshInto_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetAccountDataBorshInto'
type ReaderWriter_GetAccountDataBorshInto_Call struct {
	*mock.Call
}
...
func (_e *ReaderWriter_Expecter) GetAccountDataBorshInto(ctx interface{}, addr interface{}, accountType interface{}) *ReaderWriter_GetAccountDataBorshInto_Call {
	return &ReaderWriter_GetAccountDataBorshInto_Call{Call: _e.mock.On("GetAccountDataBorshInto", ctx, addr, accountType)}
}

func (_c *ReaderWriter_GetAccountDataBorshInto_Call) Run(run func(ctx context.Context, addr solana.PublicKey, accountType interface{})) *ReaderWriter_GetAccountDataBorshInto_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *ReaderWriter_GetAccountDataBorshInto_Call) Return(err error) *ReaderWriter_GetAccountDataBorshInto_Call {
	_c.Call.Return(err)
	return _c
}

func (_c *ReaderWriter_GetAccountDataBorshInto_Call) RunAndReturn(run func(context.Context, solana.PublicKey, interface{}) error) *ReaderWriter_GetAccountDataBorshInto_Call {
	_c.Call.Return(run)
	return _c
}
...
// GetProgramAccountsWithOpts provides a mock function with given fields: ctx, program, opts
func (_m *ReaderWriter) GetProgramAccountsWithOpts(ctx context.Context, program solana.PublicKey, opts *rpc.GetProgramAccountsOpts) (rpc.GetProgramAccountsResult, error) {
	ret := _m.Called(ctx, program, opts)
...
func (_e *ReaderWriter_Expecter) GetProgramAccountsWithOpts(ctx interface{}, program interface{}, opts interface{}) *ReaderWriter_GetProgramAccountsWithOpts_Call {
	return &ReaderWriter_GetProgramAccountsWithOpts_Call{Call: _e.mock.On("GetProgramAccountsWithOpts", ctx, program, opts)}
}

func (_c *ReaderWriter_GetProgramAccountsWithOpts_Call) Run(run func(ctx context.Context, program solana.PublicKey, opts *rpc.GetProgramAccountsOpts)) *ReaderWriter_GetProgramAccountsWithOpts_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *ReaderWriter_GetProgramAccountsWithOpts_Call) Return(out rpc.GetProgramAccountsResult, err error) *ReaderWriter_GetProgramAccountsWithOpts_Call {
	_c.Call.Return(out, err)
	return _c
}
...
func (_m *ReaderWriter) SlotHeightWithCommitment(ctx context.Context, commitment rpc.CommitmentType) (uint64, error) {
...
// ReaderWriter_SlotHeightWithCommitment_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'SlotHeightWithCommitment'
type ReaderWriter_SlotHeightWithCommitment_Call struct {
	*mock.Call
}
...
//   - ctx context.Context
//   - commitment rpc.CommitmentType
func (_e *ReaderWriter_Expecter) SlotHeightWithCommitment(ctx interface{}, commitment interface{}) *ReaderWriter_SlotHeightWithCommitment_Call {
	return &ReaderWriter_SlotHeightWithCommitment_Call{Call: _e.mock.On("SlotHeightWithCommitment", ctx, commitment)}
}

func (_c *ReaderWriter_SlotHeightWithCommitment_Call) Run(run func(ctx context.Context, commitment rpc.CommitmentType)) *ReaderWriter_SlotHeightWithCommitment_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *ReaderWriter_SlotHeightWithCommitment_Call) Return(_a0 uint64, _a1 error) *ReaderWriter_SlotHeightWithCommitment_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *ReaderWriter_SlotHeightWithCommitment_Call) RunAndReturn(run func(context.Context, rpc.CommitmentType) (uint64, error)) *ReaderWriter_SlotHeightWithCommitment_Call {
	_c.Call.Return(run)
	return _c
}
