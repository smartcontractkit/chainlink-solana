...
require (
	...
	github.com/smartcontractkit/chainlink-framework/metrics v0.0.0-20250428131713-c3486bf525fa
	github.com/smartcontractkit/chainlink-framework/multinode v0.0.0-20250428131713-c3486bf525fa
