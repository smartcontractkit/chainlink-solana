...
require (
	...
	github.com/smartcontractkit/chainlink-evm v0.0.0-20250411155010-980c0e41c2e2 // indirect
	...
	github.com/smartcontractkit/chainlink/v2 v2.22.1-por-beta.5.0.20250415235232-2401aa039a56 // indirect
