...
require (
	...
	github.com/smartcontractkit/chainlink-common/observability-lib v0.0.0-20240826172653-9ee1e8cc8b97
...
require (
	...
	github.com/grafana/grafana-foundation-sdk/go v0.0.0-20240717180137-18b7def9b008 // indirect
