...
func (inst *SetValidatorConfig) SetOwnerAccount(owner ag_solanago.PublicKey) *SetValidatorConfig {
	inst.AccountMetaSlice[1] = ag_solanago.Meta(owner)
	return inst
}

// GetOwnerAccount gets the "owner" account.
func (inst *SetValidatorConfig) GetOwnerAccount() *ag_solanago.AccountMeta {
...
func NewSetValidatorConfigInstruction(
	...
	authority ag_solanago.PublicKey) *SetValidatorConfig {
