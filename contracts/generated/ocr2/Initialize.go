			...
			programBranch.Child(ag_format.Instruction("Initialize")).
				...
				ParentFunc(func(instructionBranch ag_treeout.Branches) {
					...
					instructionBranch.Child("Accounts[len=13]").ParentFunc(func(accountsBranch ag_treeout.Branches) {
						...
						accountsBranch.Child(ag_format.Meta("                     feed", inst.AccountMetaSlice.Get(1)))
						...
						accountsBranch.Child(ag_format.Meta("           vaultAuthority", inst.AccountMetaSlice.Get(6)))
						accountsBranch.Child(ag_format.Meta("requesterAccessController", inst.AccountMetaSlice.Get(7)))
						accountsBranch.Child(ag_format.Meta("  billingAccessController", inst.AccountMetaSlice.Get(8)))
