...
func (inst *PayOracles) SetTokenReceiverAccount(tokenReceiver ag_solanago.PublicKey) *PayOracles {
	inst.AccountMetaSlice[3] = ag_solanago.Meta(tokenReceiver).WRITE()
	return inst
}

// GetTokenReceiverAccount gets the "tokenReceiver" account.
func (inst *PayOracles) GetTokenReceiverAccount() *ag_solanago.AccountMeta {
