...
func (inst *AcceptOwnership) SetProposedOwnerAccount(proposedOwner ag_solanago.PublicKey) *AcceptOwnership {
	inst.AccountMetaSlice[1] = ag_solanago.Meta(proposedOwner).SIGNER()
	return inst
}

// GetProposedOwnerAccount gets the "proposedOwner" account.
func (inst *AcceptOwnership) GetProposedOwnerAccount() *ag_solanago.AccountMeta {
...
func NewAcceptOwnershipInstruction(
	...
	proposedOwner ag_solanago.PublicKey) *AcceptOwnership {
