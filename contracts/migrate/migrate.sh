...
main() {
    ...
    #
    solana-test-validator -l migrate/test-ledger --bpf-program $PROGRAM_ID migrate/store.so --bpf-program 2F5NEkMnCRkmahEAcQfTQcZv1xtGgrWFfjENtTwHLuKg target/deploy/access_controller.so --bpf-program 2zqDPfT7nqvL7NrptW13BVmaXcZqyin7RubAGfxEK1om examples/hello-world/target/deploy/hello_world.so > migrate/validator.log &
    #
