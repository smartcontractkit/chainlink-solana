...
function modify_program {
  ...
  sed -i "s/whV7Q5pi17hPPyaPksToDw1nMx6Lh8qmNWKFaLRQ4wz/$keystone_forwarder/" "${BASH_SOURCE%/*}/../contracts/programs/keystone-forwarder/src/lib.rs"
  sed -i "s/5z38tFCAmcPJb1DXUHSoKQhR8qQ8o9aNZ8rZFWe6gH4L/$dummy_receiver/" "${BASH_SOURCE%/*}/../contracts/programs/dummy-receiver/src/lib.rs"
