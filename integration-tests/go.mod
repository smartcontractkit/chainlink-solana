...
require (
	...
	github.com/smartcontractkit/chainlink/integration-tests v0.0.0-20240715175313-4992f5dbc3d7
	github.com/smartcontractkit/chainlink/v2 v2.10.0-beta0.0.20240715175313-4992f5dbc3d7
