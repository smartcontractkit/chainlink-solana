...
require (
	...
	github.com/smartcontractkit/chainlink/integration-tests v0.0.0-20230411152732-03b771ba4397
...
require (
	...
	github.com/smartcontractkit/chainlink/v2 v2.0.0-beta0 // indirect
