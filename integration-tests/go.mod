...
require (
	...
	github.com/smartcontractkit/chainlink/integration-tests v0.0.0-20240610200823-2d83adb250be
	github.com/smartcontractkit/chainlink/v2 v2.10.0-beta0.0.20240610200823-2d83adb250be
