...
require (
	...
	github.com/smartcontractkit/chainlink/integration-tests v0.0.0-20230504214042-cd849467f954
...
require (
	...
	github.com/smartcontractkit/ocr2vrf v0.0.0-20230501212125-88509cd4bc03 // indirect
