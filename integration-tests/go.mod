...
require (
	...
	github.com/smartcontractkit/chainlink/integration-tests v0.0.0-20240710160749-a843b2729be6
	github.com/smartcontractkit/chainlink/v2 v2.10.0-beta0.0.20240710160749-a843b2729be6
