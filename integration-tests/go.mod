...
require (
	...
	github.com/smartcontractkit/chainlink/integration-tests v0.0.0-20240219204410-60392982e3cf
	github.com/smartcontractkit/chainlink/v2 v2.9.0-beta0.0.20240219204410-60392982e3cf
